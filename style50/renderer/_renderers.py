...
def to_ansinc(files, score, version):
    lines = ["Results generated by style50 v{}".format(version)]

    # Use same header as more.
    header = "{0}\n{{}}\n{0}".format(":" * 14) if len(files) > 1 else None
    ...
    for file in files:
        ...
        if file["comments"]:
            lines.append("{} consider adding more comments!".format(conjunction))
